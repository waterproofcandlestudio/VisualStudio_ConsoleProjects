...
namespace PracticaFinal2_MiguelRodriguezGallego
{
    public partial class BlackJack : Form
    {
        ...
        private void betPlayer1_Click_1(object sender, EventArgs e) {   p1.coin--; p1.bet++; lblBetP1.Text = p1.bet.ToString(); RefreshStatistics();    }
        private void betPlayer2_Click_1(object sender, EventArgs e) {   p2.coin--; p2.bet++; lblBetP1.Text = p2.bet.ToString(); RefreshStatistics();    }
