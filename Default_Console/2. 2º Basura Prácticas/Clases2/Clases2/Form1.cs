        ...
        private void cbCharacters_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (cbCharacters.SelectedIndex)
            {
                case 0:
                    ...
                    btnAttackPlayer.Visible = true;
                    btnAttackEnemy.Visible = false;
                    break;
                case 1:
                    lblNameEnemy.Text = p1.GetName();
                    lblHealthEnemy.Text = p1.GetHealth().ToString();
                    lblDamageEnemy.Text = p1.GetDamage().ToString();

                    lblNamePlayer.Text = e1.GetName();
                    lblHealthPlayer.Text = e1.GetHealth().ToString();
                    lblDamagePlayer.Text = e1.GetDamage().ToString();

                    btnAttackPlayer.Visible = false;
                    btnAttackEnemy.Visible = true;
                    break;
                default:
